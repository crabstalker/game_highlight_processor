...
RAPIDAPI_KEY="956b4a24d7msh579776298a849e1p164cc2jsn27210514102b"
S3_BUCKET_NAME="lbrapids"
...
WAIT_TIME_BETWEEN_SCRIPTS = int(os.getenv("WAIT_TIME_BETWEEN_SCRIPTS", "10")) 
...
S3_BUCKET_NAME = os.getenv("S3_BUCKET_NAME", "lbrapids")
